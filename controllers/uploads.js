...
const actualizarImagen = async (req = request, res = response) => {
    ...
    switch (coleccion) {
        ...
        case 'productos':
            ...
            break
        default: return res.status(500).json({ msg: 'Colección inalcanzable.' })
    }
    if (modelo.img) {
    ...
    modelo.img = nombre
    await modelo.save()
    res.json({ msg: `Imagen: ${nombre} subida exitosamente.` })
}
...
module.exports = { cargarArchivo, actualizarImagen, mostrarImagen, actualizarImagenCloudDinary }